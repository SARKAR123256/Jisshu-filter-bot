...
BOT_TOKEN = environ.get('BOT_TOKEN', '8194500582:AAH25U0KhFfrfV19nUrXI4exy2lDWsoilx4')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002421090499'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+KHta08OoBQ0wOWI1')
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002421090499'))  # set shortner log channel
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+KHta08OoBQ0wOWI1') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
